...
(/** @lends <global> */function($, window, document, undefined) {
    ...
    var alfhabe = ["a", "b", "c", "ç", "d", "e", "f", "g", "ğ", "h", "ı", "i", "j", "k", "l", "m", "n", "o", "ö", "p", "q",  "r", "s", "ş", "t", "u", "ü", "v", "w", "x", "y", "z"];
	...
	$.extend( DataTable.ext.oSort, {
        ...
        */
        "string-asc": function (a, b) {
            ...
            var x = alfhabe.indexOf(a.toLowerCase().substring(0, 1));
            var y = alfhabe.indexOf(b.toLowerCase().substring(0, 1));
            if (x == y) {
                x = a.toLowerCase();
                y = b.toLowerCase();
            }
